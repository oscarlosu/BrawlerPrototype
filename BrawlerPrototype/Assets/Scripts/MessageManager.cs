/*
Source: http://www.gamasutra.com/blogs/DarrelCusey/20130829/199271/A_Simple_Observer_Pattern_for_Unity_42.php
...
public class MessageBehaviour : MonoBehaviour {
	...
	public void Start()
	{
		...
		Messenger = GameObject.Find("MessageManager").GetComponent<MessageManager>();
		if(!Messenger) Debug.LogError("MessageManager.MessageManager could not be found.  Insure there is a MessageManager object with a MessageManager script attached.");
		OnStart();
	}
